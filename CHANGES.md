...
- **Aria now hosted on RunPod** (A40 48GB): full MnemonicAI stack — memory,
...
## 2026-07-12 — Aria v4 "Identity Repair"
...
- Fixed: sanitized template (Aria, created by Sergio Williams — Surge),
